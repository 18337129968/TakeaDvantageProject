...
public class IntegralStaticsPayMoneyActivity extends HeadBaseActivity {
	// 下面的配置告诉应用去assets目录下找安装包
	public static final String ALIPAY_PLUGIN_NAME = "zhifubao_77.apk";
	private int userGoldNum;
	public TextView tv_gold, tv_money;
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SUCCESS:
				...
				break;
			case FAIL:
				ToastUtils.makeText(IntegralStaticsPayMoneyActivity.this,
						"访问服务器失败!", 0).show();
				break;
			default:
				break;
		...
		case R.id.btn_pay:
			if (cbox == 1) {
				...
				if (Util.checkLocalAppExistOrNot(
						IntegralStaticsPayMoneyActivity.this,
						"com.eg.android.AlipayGphone")) {
					pay("购买金币",
							"购买金币",
							Arith.div(Double.parseDouble(tv_gold.getText()
									.toString()), 100)
									+ "", UserId);
				} else {
					ToastUtils.makeText(IntegralStaticsPayMoneyActivity.this,
	...
	public void initReplaceView() {
		...
		View view = View.inflate(IntegralStaticsPayMoneyActivity.this,
				R.layout.integralstaticspaymoney, null);
	...
	public void initView() {
		...
		Arith.div(Double.parseDouble(tv_gold.getText().toString()), 100);
		tv_money.setText(Arith.div(
				Double.parseDouble(tv_gold.getText().toString()), 100)
				+ "");
	}
	...
	private void QueryGoldNum() {
		...
		user.userId = GetUserIdUtil
				.getUserId(IntegralStaticsPayMoneyActivity.this);
		user.tokenId = GetUserIdUtil
				.getTokenId(IntegralStaticsPayMoneyActivity.this);
		final Gson gson = new Gson();
		String json = gson.toJson(queryGoldNumRequest);
		HttpConnectTool.update(json, IntegralStaticsPayMoneyActivity.this,
				new ConnectListener() {
						...
						if (!TextUtils.isEmpty(result)) {
							...
							if (queryGoldNumResult.p.isTrue) {
								...
								LoginUserResult login = GetUserIdUtil
										.getLogin(IntegralStaticsPayMoneyActivity.this);
								...
								IntentActivity
										.mIntent(IntegralStaticsPayMoneyActivity.this);
							}
						}
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					ToastUtils.makeText(IntegralStaticsPayMoneyActivity.this,
							"支付成功!", 0).show();
					QueryGoldNum();
					IntegralStaticsPayMoneyActivity.this.finish();
				} else {
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						...
						ToastUtils.makeText(
								IntegralStaticsPayMoneyActivity.this, "支付失败!",
								0).show();
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(IntegralStaticsPayMoneyActivity.this,
	...
	public void getSDKVersion() {
		PayTask payTask = new PayTask(IntegralStaticsPayMoneyActivity.this);
		String version = payTask.getVersion();
		Toast.makeText(IntegralStaticsPayMoneyActivity.this, version,
