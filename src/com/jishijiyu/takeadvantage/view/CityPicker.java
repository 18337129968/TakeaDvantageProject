...
public class CityPicker extends LinearLayout {
	...
	public String getProvinceCode() {
		int provincePositon = provincePicker.getSelected();
		return province_list.get(provincePositon).getId();
	}

	public String getCityCode() {
		int cityPositon = cityPicker.getSelected();
		return city_map.get(getProvinceCode()).get(cityPositon).getId();
	}

	public String getAreaCode() {
		int AreaPositon = counyPicker.getSelected();
		return couny_map.get(getCityCode()).get(AreaPositon).getId();
	}
